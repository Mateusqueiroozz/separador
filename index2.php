...
<form action="impressao_add.php" method="get" id="formprin" data-ajax="false"class="needs-validation">
  <div class="form-row">
    ...
    <div class="col-md-4 mb-3">
      ...
      <div class="input-group">        
        <input type="text" class="form-control" id="valor" placeholder="" name="valor" aria-describedby="inputGroupPrepend" required>
      </div>
    </div>
	<div class="col-md-4 mb-3">
  ...
  <div  class="pesquisar">
  <a href="impressao_novo.php"  type="submit" data-ajax="false" >Sim</a>
  </div>
