...
! function(t) {
    t.kc || (t.kc = new Object), t.kc.fab = function(n, a, i) {
        ...
        var l, e;
        o.init = function() {
            if (("undefined" == typeof a || null === a) && (a = [{ url: null, bgcolor: "red", icon: "+" }, { url: "http://www.example.com", bgcolor: "orange", icon: "+" }, { url: "http://www.example.com", bgcolor: "yellow", icon: "+" }]), o.links = a, o.links.length > 0) {
