...
GROUP BY
impressao.codigo");
	while ($linha = mysqli_fetch_array($consultaimp)){
		echo $linhaimp['codigo'];
		$ordem ++;
	 $quebra = "\n";
        $c = 0;
		$txtaltera = "";
...
<body> 
			<div class="ui-corner-all custom-corners">
				...
				<div class="ui-corner-all custom-corners">
						<div class="ui-bar ui-bar-a" style="text-align:center; color:red; height:40px; line-height:40px">As etiquetas foram impressas corretamente?</div>
				</div>
				<div class="confirma" style="text-align:center">
					<a href="impressao_novo.php" onclick="adiciona.submit();" data-ajax="false" style="background-color:green;color:white;font-weight: normal;" class="ui-btn ui-btn-inline ui-icon-check ui-btn-icon-left">Sim</a>
                    
                    
					<a href="impressao_imprimir.php" data-ajax="false" style="background-color:red;color:white;font-weight: normal;" class="ui-btn ui-btn-inline ui-icon-delete ui-btn-icon-right">Não</a>
					<a href="index.php" data-ajax="false" style="background-color:orange;color:white;font-weight: normal;" class="ui-btn ui-btn-inline ">Não sei</a>
