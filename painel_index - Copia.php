            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card card-secondary">
                        ...
                        <div class="card-body">
                            <form action="painel_impressao.php" method="post">
                                <div class="row">
                                    <div class="col-md-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4" id="imprime">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="impressora" class="form-control select2 select2-danger"
                                                data-dropdown-css-class="select2-danger" style="width: 100%;">
                                                <option value="1">Impressora 01</option>
                                                <option value="2">Impressora 02</option>
                                                <option>Impressora 03</option>
                                                <option>Impressora 04</option>
                                                <option>Impressora 05</option>
                                                <option>Impressora 06</option>
                                                <option>Impressora 07</option>
                                            </select>
                                        </div>
                                        <!-- /.form-group -->
                                    </div>
                                ...
                                <button type="submit" class="btn-lg btn-danger">Iniciar
                                    separação</button>
                            </form>
                            <br>
